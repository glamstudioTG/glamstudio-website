    ...
    <DayPicker
      ...
      classNames={{
        ...
        button_previous: cn(
          ...
          "size-8 aria-disabled:opacity-50 p-0 select-none shrink-0",
        ...
        day: cn(
          "relative flex-1 min-w-0 p-0 text-center select-none",
  ...
  return (
    <Button
      ...
      className={cn(
        ...
        "data-[selected-single=true]:shadow-[0_0_12px_rgba(212,166,78,0.6)]",
