...
export default function HeroSection() {
  return (
    <>
      <section className="relative w-full min-h-[600px] bg-[#FFEEE4] overflow-hidden flex items-center">
        ...
        h-full w-80
        -translate-x-1/2
        bg-gradient-to-r from-[#ffeee4] 
      "
          />
        </div>
        <div className="relative z-10 max-w-7xl mx-auto w-full grid grid-cols-1 md:grid-cols-2 px-20 items-center">
          <div className="flex flex-col gap-6 max-w-md">
            ...
            <div className="flex items-center gap-10 pt-4">
              <CornerAccentButton>Reserva tu cita</CornerAccentButton>

              <MagneticButton className="bg-amber-50">
